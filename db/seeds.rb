...
array_specialties =['Internal medicine','Psychiatry','Anesthesiology','Surgery','Nuclear medicine','Plastic surgery','Orthopedics','Sports medicine']

array_cities = ['Tokyo','Sapporo','Kyoto','Kobe','Nagoya','Osaka','Nagasaki','Yokohama']
